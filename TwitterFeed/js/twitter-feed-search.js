(function($) {	
	$(document).ready(function () {
		...
		var headerHTML = '';
		var loadingHTML = '';
		headerHTML += '<a href="https://twitter.com/" ><img src="images/tweet-actions.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
						...
						if(typeof feeds[i].retweeted_status != 'undefined'){
						 ...
						 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false)))) { 
							if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
								...
								feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" ><img src="'+profileimage+'"images/tweet-actions.png" width="42" height="42" alt="twitter icon" /></a></div>';
